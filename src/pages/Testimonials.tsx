      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Watch Our Client Success Story</h2>
            <p className="text-xl text-gray-600">
              See how we helped transform a business through innovative web solutions
            </p>
          </div>
          
          <div className="relative rounded-3xl overflow-hidden card-3d animate-scale-in">
            <div className="aspect-video bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center">
              <iframe
                className="w-full h-full"
                src="https://www.youtube.com/embed/KCZYlHG35SI"
